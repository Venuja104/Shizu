...
@run_async
def Shizu_about_callback(update, context):
    query = update.callback_query
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Shizu_about_callback, pattern=r"aboutmanu_"
    )
